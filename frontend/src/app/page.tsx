          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-white transition-colors">Lenders Portal</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Developers Portal</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Buyers Portal</a></li>
